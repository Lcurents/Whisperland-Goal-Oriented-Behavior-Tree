...
namespace WOTR.Game
{
    ...
    {
        private static readonly Bounds Bounds = new Bounds(Vector3.zero, new Vector3(15, 8, 0));
        ...
        private Vector3 GetRandomPosition(IActionReceiver agent)
        {
            ...
            var position = agent.Transform.position + new Vector3(random.x, random.y, 0f);
