...
namespace WOTR.Game
{
    public class AgentMoveBehaviour : MonoBehaviour
    {
        ...
        public void Update()
        {
            ...
            this.transform.position = Vector3.MoveTowards(this.transform.position, new Vector3(this.currentTarget.Position.x, this.currentTarget.Position.y, this.transform.position.z), Time.deltaTime);
        }
